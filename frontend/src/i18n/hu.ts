const hu = {
  ...
  connectingInfo:
    "A szerver lehet alvó módba került, emiatt kicsit tovább tarthat a csatlakozás. Kérlek, légy türelemmel!",
  enterName: "Adj meg egy nevet!",
  codeLength: "A kódnak 4 karakter hosszúnak kell lennie!",

  // NameStep.tsx
  tagline:
    "Úgy érzed, hogy a zenei ismereted magas? Képes vagy csupán hangból megállapítani az évet?",
  ...
  modeSubtitle:
    "Egyedül szeretnél játszani, vagy a barátaiddal mérnéd össze a zenei tudásod?",
  modeSoloTitle: "Egyjátékos",
  modeSoloDesc:
    "Tedd próbára magad egyedül az idővel szemben. Helyezd el a kártyákat sorrendben!",
  modeMultiTitle: "Többjátékos",
  modeMultiDesc:
    "Hívd ki a barátaidat online, és derítsétek ki, ki a zenei zseni a csapatban!",
  modeWeeklyTitle: "Heti Kihívás",
  modeWeeklyDesc:
    "Minden héten új 20 dal. Legyél minél pontosabb, minél gyorsabb és kerülj fel a heti ranglistára!",
  ...
  soloCustomizeDesc:
    "Állítsd be, hány körből álljon a kihívás. Minden körben egy újabb kártyát próbálhatsz meg elhelyezni a timeline-on.",
  ...
  multiNewGameDesc:
    "Készíts egy új szobát, ahová a barátaid csatlakozhatnak a kóddal.",
  ...
  lobbySyncMusicDesc:
    "A szinkronizált lejátszás bekapcsolásakor a soron lévő játékos irányítja mindenki zenelejátszóját.",
  ...
  weeklyRule1:
    "Nincs hibahatár: A játék csak akkor ér véget, ha mind a 20 kört végigjátszottad.",
  ...
  weeklyRule2End: "dönt.",
  weeklyRule2:
    "A ranglista helyezést az elért eredmény határozza meg, holtverseny esetén a kevesebb idő dönt.",
  weeklyRule3:
    "A tisztességes verseny fenntartása érdekében minden játékos hetente csak egy alkalommal vegyen részt a heti kihívásban.",
  ...
  weeklyBeFirst:
    "Legyél te az első ezen a héten, aki felkerül a dicsőségtáblára!",
  ...
  weeklyLeaveWarning:
    "Ha most kilépsz, az aktuális játékállás elmentésre kerül, így legközelebb ugyaninnen tudod folytatni.",
  ...
  tutorialNameItem1Desc:
    "A ChronoTune egy idővonal-építő játék, ahol a dalokat a megjelenési évük szerint kell elhelyezned az idővonalon. Ehhez mindössze egy 30 másodperces részletet hallgathatsz meg az adott dalból.",
  tutorialNameItem2Title: "Hogyan kell játszani?",
  tutorialNameItem2Desc:
    "Hallgasd meg a zenét, húzz egy kártyát és illeszd a már meglévő idővonalra a megfelelő helyre! Ha eltalálod a sorrendet, a kártya az idővonal része marad.",
  tutorialNameItem3Title: "Változatos játékmódok",
  tutorialNameItem3Desc:
    "Játssz egyedül a saját tempódban, teszteld tudásodat a barátaiddal többjátékos módban, vagy versenyezz a heti ranglistán!",
  ...
  tutorialSoloItem1Desc:
    "Válaszd ki, hány kört szeretnél játszani (5–20). Minden körben egy új dalt kapsz, amelyet el kell helyezned az idővonalon. Helyes válasz esetén pontot kapsz, és a dal az idővonalra kerül. Hibás válasz esetén pontot veszítesz, a dal pedig eldobásra kerül",
  ...
  tutorialSoloItem3Desc:
    "Állítsd be a kívánt nehézséget. A 'Hardcore' módban egyetlen hiba azonnali vereséget jelent, míg a 'Relaxed' módban nincs hibahatár.",
  tutorialSoloItem4Title: "Dalforrás",
  tutorialSoloItem4Desc:
    "Válassz magyar vagy nemzetközi dalok közül. Magyar módban csak magyar nyelvű számokat, nemzetközi módban pedig a világ minden tájáról származó dalokat kaphatsz.",
  ...
  tutorialMultiItem1Desc:
    "Hozz létre egy szobát és oszd meg a 4 jegyű szobakódot a barátaiddal, vagy csatlakozz egy meglévő szobához.",
  tutorialMultiItem2Title: "Körökre osztott játék",
  tutorialMultiItem2Desc:
    "A játékosok felváltva húznak kártyát és próbálják lerakni a saját idővonalukra. Aki a legtöbb pontot szerzi a játék során, az nyer!",
  ...
  tutorialMultiItem4Desc:
    "Ha egy játékos elhagyja a játékot, a többiek zavartalanul folytathatják azt. A kilépett játékos olyan, mintha sosem csatlakozott volna.",

  // Weekly Tutorial
  tutorialWeeklyTitle: "Heti Kihívás",
  tutorialWeeklySubtitle:
    "Egyenlő feltételek, heti 20 dal, globális dicsőségtábla!",
  tutorialWeeklyItem1Title: "Azonos lista mindenkinek",
  tutorialWeeklyItem1Desc:
    "Minden hétfőn 12:00-kor új, 20 dalból álló lista indul. A hét során minden játékos ugyanazokkal a dalokkal, ugyanabban a sorrendben játszik. Az új lista megjelenésekor az előző hét összes adata törlésre kerül!",
  tutorialWeeklyItem2Title: "Játékállás mentése",
  tutorialWeeklyItem2Desc:
    "A játékállásod automatikusan mentésre kerül, így megszakítás esetén ott folytathatod, ahol abbahagytad.",
  tutorialWeeklyItem3Title: "Heti 1 próbálkozási lehetőség",
  tutorialWeeklyItem3Desc:
    "A tisztességes verseny érdekében hetente csak egyszer vehetsz részt a kihívásban. Hozd ki magadból a maximumot!",
  ...
  // Privacy & Storage (Adatvédelem és Tárhely)
  privacyAndStorage: "Adatvédelem és Tárhely",
  privacyTitle: "Adatvédelem és Tárhely",
  privacySubtitle: "Hogyan kezeli a ChronoTune az adataidat?",
  privacyClose: "Rendben",
  privacyNoCookiesTitle: "0% követés és nincsenek marketing sütik",
  privacyNoCookiesDesc:
    "A ChronoTune nem használ hirdetési vagy viselkedéskövető sütiket (cookies). Nincs az oldalon Google Analytics, Meta Pixel vagy bármilyen harmadik féltől származó megfigyelő kód.",
  privacyStorageTitle: "Kizárólag funkcionális helyi tárhely (localStorage)",
  privacyStorageDesc:
    "Csak a játék működéséhez elengedhetetlen beállításokat tároljuk a böngésződben: a választott nyelvet, a hangerőt, az útmutatók megtekintési állapotát és a heti kihívás játékmenetének folytatását.",
  privacyDataTitle: "Személyes adatok védelme",
  privacyDataDesc:
    "A játékhoz regisztráció nem szükséges. Nem gyűjtünk és nem tárolunk személyes adatokat, profilokat, jelszavakat vagy bankkártyaadatokat.",
};
